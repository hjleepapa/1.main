...
Handles both HTTP requests (for health checks) and WebSocket connections.
"""
...
async def main():
    ...
    logger.info("Starting Sambanova Twilio Media Streams server on localhost:5001")
    ...
    logger.info("Ready to accept Sambanova Twilio Media Streams connections...")
