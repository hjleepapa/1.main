#!/usr/bin/env python3
"""
Startup script to run both Flask server and WebSocket server for Convonet voice integration.
"""
...
def start_websocket_server():
    ...
    print("Starting Convonet WebSocket server on port 5001...")
    # Use the virtual environment Python
    venv_python = os.path.join(os.getcwd(), "venv", "bin", "python")
    if os.path.exists(venv_python):
        websocket_cmd = [venv_python, "convonet/http_websocket_server.py"]
    else:
        websocket_cmd = [sys.executable, "convonet/http_websocket_server.py"]
...
def main():
    ...
    print("🚀 Starting Convonet Todo Voice Integration Servers...")
    print("=" * 60)
    ...
    print("📱 Convonet Web Interface: http://localhost:5000/convonet_todo/")
    print("📞 Local Twilio Webhook: http://localhost:5000/convonet_todo/twilio/call")
    print("🌐 Production Twilio Webhook: https://hjlees.com/convonet_todo/twilio/call")
    print("🔌 Production WebSocket: wss://hjlees.com/convonet_todo/ws")
    print("=" * 60)
