"""
Environment Configuration for Convonet Project
...
class EnvironmentConfig:
    """Environment configuration manager for Convonet project"""
    ...
    CONVONET_API_KEY: str = os.getenv('CONVONET_API_KEY', '')
    ...
    WEBSOCKET_BASE_URL: str = os.getenv('WEBSOCKET_BASE_URL', 'wss://hjlees.com/convonet_todo/ws')
    ...
    def print_config_summary(cls):
        ...
        print("🔧 Convonet Environment Configuration Summary")
        print("=" * 50)
