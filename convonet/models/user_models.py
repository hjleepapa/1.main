...
class TeamMembership(Base):
    __tablename__ = "team_memberships_convonet"
    
    id = Column(UUID(as_uuid=True), primary_key=True, default=uuid.uuid4)
    team_id = Column(UUID(as_uuid=True), ForeignKey('teams_convonet.id'), nullable=False)
    user_id = Column(UUID(as_uuid=True), ForeignKey('users_convonet.id'), nullable=False)
