...
async def main():
    ...
    logger.info("Starting Convonet Twilio Media Streams server on localhost:5001")
    ...
    logger.info("Ready to accept Convonet Twilio Media Streams connections...")
