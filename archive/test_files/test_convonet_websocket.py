#!/usr/bin/env python3
"""
Test Convonet WebSocket endpoints on hjlees.com
"""
...
async def test_convonet_websocket():
    """Test Convonet WebSocket endpoints."""
    
    test_urls = [
        "wss://hjlees.com",
        "wss://hjlees.com/ws", 
        "wss://hjlees.com/convonet_todo",
        "wss://hjlees.com/convonet_todo/ws",
        "wss://hjlees.com/convonet_todo/twilio/ws",
    ]
    
    print("🔍 Testing Convonet WebSocket Endpoints on hjlees.com")
    print("=" * 60)
...
def test_http_endpoints():
    ...
    test_urls = [
        "https://hjlees.com",
        "https://hjlees.com/convonet_todo",
...
async def main():
    ...
    websocket_works = await test_convonet_websocket()
