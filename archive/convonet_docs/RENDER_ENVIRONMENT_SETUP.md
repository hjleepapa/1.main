...
This guide shows how to configure all environment variables for your Convonet Hackathon project on Render.com.
...
- **Example**: `postgresql://user:pass@dpg-abc123.oregon-postgres.render.com:5432/convonet_db`
...
- **Example**: `convonet-hackathon-2025-secret-key-abc123`
...
WEBSOCKET_BASE_URL=wss://your-app-name.onrender.com/convonet_todo/ws
```
- **Purpose**: Twilio webhook endpoints
- **Render**: Replace `your-app-name` with your actual Render app name
- **Example**: `WEBHOOK_BASE_URL=https://convonet-hackathon.onrender.com`
...
services:
  - type: web
    name: convonet-hackathon
    env: python
    buildCommand: pip install -r requirements.txt
    startCommand: python start_convonet_asgi.py
    envVars:
      - key: DB_URI
        fromDatabase:
          name: convonet-db
...
**🎉 Your Convonet project is now ready for Render.com deployment with Redis and Composio integrations!**
