#!/usr/bin/env python3
"""
Start Convonet with ASGI support for WebSocket
"""
...
def start_asgi_server():
    ...
    print("🚀 Starting Convonet ASGI Server with WebSocket support...")
...
'''
    ...
    with open("deploy_convonet_asgi.sh", "w") as f:
        f.write(script_content)
    
    os.chmod("deploy_convonet_asgi.sh", 0o755)
    print("✅ Created deploy_convonet_asgi.sh")
