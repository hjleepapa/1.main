#!/usr/bin/env python3
"""
Startup script to run both Flask server and WebSocket server for Sambanova voice integration.
"""
...
def start_websocket_server():
    ...
    print("Starting Sambanova WebSocket server on port 5001...")
    # Use the virtual environment Python
    venv_python = os.path.join(os.getcwd(), "venv", "bin", "python")
    if os.path.exists(venv_python):
        websocket_cmd = [venv_python, "sambanova/http_websocket_server.py"]
    else:
        websocket_cmd = [sys.executable, "sambanova/http_websocket_server.py"]
...
def main():
    ...
    print("🚀 Starting Sambanova Todo Voice Integration Servers...")
    print("=" * 60)
    ...
    print("📱 Sambanova Web Interface: http://localhost:5000/sambanova_todo/")
    print("📞 Local Twilio Webhook: http://localhost:5000/sambanova_todo/twilio/call")
    print("🌐 Production Twilio Webhook: https://hjlees.com/sambanova_todo/twilio/call")
    print("🔌 Production WebSocket: wss://hjlees.com/sambanova_todo/ws")
    print("=" * 60)
